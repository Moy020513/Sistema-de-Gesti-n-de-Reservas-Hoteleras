package com.damoi.commons.controller;
...
public class CommonController<RQ, RS, S extends CrudService<RQ, RS>> {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<RS> obtenerPorId(@PathVariable @Positive(message = "Id debe ser positivo") Long id){
    ...
    @PutMapping("/{id}")
    public ResponseEntity<RS> actualizar(@PathVariable @Positive(message = "Id debe ser positivo") Long id,
